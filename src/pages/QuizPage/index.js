...
export default function Questions() {
    ...
    const handleNextQuestion = () => {
        ...
        if (!selectedOption) {
            Alert.alert('É necessário selecionar uma resposta.');
            return;
        }
    ...
    return (
        <Animatable.View style={styles.container} animation={""} delay={0}>
        ...
        <View style={{ flexDirection: 'row', marginTop: 20 }}>
            ...
            <TouchableOpacity
                ...
                onPress={() => {
                    if (!selectedOption) {
                        Alert.alert('É necessário escolher uma resposta.');
                        return;
                    }
